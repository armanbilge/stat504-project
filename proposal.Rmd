---
title: "Stat 504 Homework 2 Part I: Project Idea"
author: Arman Bilge
date: January 25
---
...
```{r hist, echo = F, dev = 'pdf', fig.width = 7.5, fig.height = 3.5, fig.cap = "Histograms of covariates and outcome."}
par(mfrow = c(1, 3))
...
```{r scatter, echo = F, dev = 'pdf', fig.width = 7.5, fig.height = 4.5, fig.cap = "Scatterplots of covariates and outcome."}
par(mfrow = c(1, 2))
